...
class Options:
    ...
    def _initial(self):
        ...
        #                     Running options
        # ===============================================================
        self.parser.add_argument('--lr', type=float, default=0.5)
        ...
        self.parser.add_argument('--input_n', type=int, default=5, help='observed seq length')
        self.parser.add_argument('--output_n', type=int, default=5, help='future seq length')
